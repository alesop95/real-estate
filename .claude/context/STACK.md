...
`excel_builder.py` e' il generatore. La classe `Costruttore` tiene il registro dei nomi definiti e costruisce i quattordici fogli in sequenza. I riferimenti fra fogli passano sempre per nomi definiti, mai per indirizzi di cella, il che rende le formule leggibili e resistenti allo spostamento delle righe.
