...
```
Branch attivo:         web
Commit di riferimento: 137a863, schede allineate; fase tre in corso, non ancora committata
...
Applicazione web:      103 prove verdi in due ambienti, schema, cinque rotte, interfaccia e
                       la prima delle sei aree; niente di remoto
...
Interfaccia:           React con TypeScript costruito da Vite, servito dal Worker come
                       risorse statiche; area immobile scritta, cinque aree da scrivere
Regole condivise:      app/src/condiviso/, per ADR-027: forma dell'immobile, ruoli, e il
                       catalogo delle trenta verifiche generato da src/immobiliare/verifiche.py
Branch di lavoro:      web; fase uno e parte locale della fase due chiuse il 7 settembre,
                       fase tre cominciata il 14 settembre
```

Committato fino a `137a863`, che allinea le schede di memoria al lavoro del 9 settembre. Il lavoro del 14 settembre, cioè la fase tre con la prima area dell'interfaccia, è sul disco e non ancora committato: i comandi sono stati consegnati all'utente, che li esegue a mano. I quattro commit che lo precedono portano in ordine lo scopo commerciale con la piattaforma Cloudflare e la voce didattica 13, la fase uno cioè il motore TypeScript con i duecentoundici vettori, la fase due in locale cioè schema, Worker e rotte autorizzate, e la procedura di messa in rete in nove passi con il flusso che distribuisce.
